...
namespace DataAccessLayer
{
    public class Common
    {
        ...
        SqlCommand sqlcmd;
        DataSet dsgetdata;
        string strcon = ConfigurationManager.ConnectionStrings["129"].ToString();
        ...
        public DataSet getInserlogrequest(string URL)
        {
            ...
            //p.Value = Method;
            //plist.Add(p);
            ds = DataAccessLayer.Common.ExecuteDataSet("Karvymfs_CommonServices_InsertResplog_insta", plist, TamperProofStringDecode(strcon, "KBCONSTR"));
            return ds;
        }
        public void updatelogrequest(int id, string request)
        {
            ...
            p.Value = request;
            plist.Add(p);
            ds = DataAccessLayer.Common.ExecuteDataSet("KarvymfsCommonServices_UpdateResplog_insta", plist, TamperProofStringDecode(strcon, "KBCONSTR"));
        }
